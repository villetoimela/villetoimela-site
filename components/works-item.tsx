  ...
  return (
    <div className="mb-10 flex w-full flex-col bg-black bg-opacity-30 font-Syne md:flex-row">
      ...
      <div className=" w-full self-center md:w-1/2 ">
        ...
        <a href={link} className={` ${btnClassName} w-full my-4 px-6 py-2 text-center font-bold text-sm text-white border-2 border-red-300 rounded-md hover:bg-red-300 duration-200 z-50 `}>LIVE || REPO</a>
        </button>
      </div>
    </div>
  )
