        ...
        <div className="flex flex-col items-center pt-10 lg:flex-row">
          <div className="relative w-full lg:w-2/3">
            <p className="font-Syne text-base font-bold tracking-wider text-gray-100 ">
              ...
              työkaluina on pyörinyt React (NextJS:llä), TypeScriptillä ja olen
              täysin rakastunut Tailwindiin! <br /> Versionhallinnan puolelta
          ...
          <div className="mt-16 flex w-full items-center lg:mt-0 lg:w-1/3 lg:pb-0 lg:pr-24">
